...
author:
  ...
  - name:         "{{< var lbarton.name >}}"
    orcid:        "{{< var lbarton.orcid >}}"
    email:        "{{< var lbarton.email >}}"
    affiliation:  "{{< var lbarton.affil >}}"
...
psyarxiv: https://psyarxiv.com/ekqrv/
osf: https://osf.io/m4fgp/
date: '2021'
date-format: "YYYY"
categories:
  - journal article
