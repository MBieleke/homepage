...
<a class="btn btn-dark rounded-pill" href="featured.png" download role="button">{{< fa file-word >}} Download</a> <a class="btn btn-dark rounded-pill" href="featured.png" download role="button">{{< fa file-pdf >}} Download</a>
