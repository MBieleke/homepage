...
<a class="btn btn-dark rounded-pill" href="aeqs.docx" download role="button">{{< fa file-word >}} AEQ-S (doc)</a> <a class="btn btn-dark rounded-pill" href="aeqs.pdf" download role="button">{{< fa file-pdf >}} AEQ-S (pdf)</a> <a class="btn btn-dark rounded-pill" href="aeqs_german.docx" download role="button">{{< fa file-word >}} AEQ-S German (doc)</a> <a class="btn btn-dark rounded-pill" href="aeqs_german.pdf" download role="button">{{< fa file-pdf >}} AEQ-S German (pdf)</a>
...
Bieleke, M., Gogol, K., Goetz, T., Daniels, L., & Pekrun, R. (2021). The AEQ-S: A short version of the Achievement Emotions Questionnaire. *Contemporary Educational Psychology*, *65*, 101940. [https://doi.org/10.1016/j.cedpsych.2020.101940](https://doi.org/10.1016/j.cedpsych.2020.101940){.external target="_blank"}
