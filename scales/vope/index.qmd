...
An overall score for each scale is obtained by averaging a participant's ratings across all four items. The items are formulated in the same direction so that no reverse-coding is neccessary.
