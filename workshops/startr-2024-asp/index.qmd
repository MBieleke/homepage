...
Die Fortbildung findet online über Zoom statt. Hier ist der Link für beide Fortbildungen:

[Zoom-Link](https://uni-konstanz-de.zoom.us/j/91445145498){.btn .btn-primary}

Für den Beitritt zum Kurs ist ein Passwort notwendig, dass ich separat per E-Mail versende. Bitte beachtet, dass der Link nur für die registrierten Teilnehmerinnen und Teilnehmer bestimmt ist.

# Vorbereitung

Für den Kurs benötigt ihr zwei Software-Programme: R und RStudio. R ist die Programmiersprache, und RStudio bietet eine benutzerfreundliche Umgebung zur Entwicklung und Analyse in R. Wenn ihr die beiden Programme nicht ohnehin schon auf dem Rechner habt, dann folgt den Schritten unten, um sie zu installieren.

## Schritt 1: R installieren
* R-Download-Seite aufrufen: Geht auf die [Download-Seite von CRAN (The Comprehensive R Archive Network)](https://cran.r-project.org/).
...
* RStudio-Download-Seite aufrufen: Besucht die [RStudio-Download-Seite](https://posit.co/download/rstudio-desktop/).
...
*  10:30 - 10:45 Uhr: *Pause*
*  10:45 - 12:15 Uhr: Datenverwalung und -manipulation
*  12:15 - 13:15 Uhr: *Mittagspause*
...
Ihr könnt die Folien im Browser als PDF abspeichern. Geht dazu wie folgt vor:
